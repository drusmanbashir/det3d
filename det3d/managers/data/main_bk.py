...
from det3d.transforms.crop_indices import monai_crop_center_to_slices, volume_fg_flat_indices
...
class LoadHDF5DetShardIndexd(MapTransform):
    """Load RandCrop fg index pool from HDF5."""
