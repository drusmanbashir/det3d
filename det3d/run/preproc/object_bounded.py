...
def main():
    parser = argparse.ArgumentParser(
        description="Object-bounded detection preprocessing to images/lms/bboxes *_bboxN.json"
    )
    ...
    generator = ObjectBoundedDataGenerator(
        project=project,
        plan=plan,
        data_folder=input_folder,
    )
    generator.setup(debug=args.debug, mean_std_mode="dataset")
