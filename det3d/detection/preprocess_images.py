# Reference copy from MONAI RetinaNet detector utilities.
# Source: monai/apps/detection/utils/detector_utils.py
# (RetinaNetDetector.forward calls preprocess_images from this module.)
#
